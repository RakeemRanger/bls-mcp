...
param log_analytics_name string = '${naming_prefix}log-workspace'
param log_analytics_msi_name string = '${naming_prefix}log-workspace-msi'
param insight_name string = '${naming_prefix}app-insights'
param search_name string = '${naming_prefix}search'
param sto_acount_name = 'prodblsmcpsto'
